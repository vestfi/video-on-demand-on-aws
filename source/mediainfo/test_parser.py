...
class TestParser(unittest.TestCase):
    ...
    def test_parse_general_attributes(self):
        track = {"Format": "MPEG-4", "FileSize": 8000000, "Duration": 21021, "OverallBitRate": 800}

        expected = {"format": "MPEG-4", "fileSize": 8000000, "duration": 21021, "totalBitrate": 800}
    ...
    def test_parse_text_attributes(self):
        track = {"ID": "1", "Format": "TXT", "Duration": 1000, "Count": 21021, "CaptionServiceName": 500}

        expected = {"id": "1", "format": "TXT", "duration": 1000, "frameCount": 21021, "captionServiceName": 500}
